...
class SopPhoneConfig(PluginConfig):
    ...
    ...
    version="0.4.13" # cannot be lower than the current
    ...
    # others plugin informations
    ...
    min_version="4.5.1" # change NetBox compatible minimum version if needed
    max_version="4.5.99" # and select a max_version if needed
